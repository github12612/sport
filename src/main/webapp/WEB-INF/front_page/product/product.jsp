			...
			<div class="mt ofc">
				<ul class="uls i_150x150 x4_150x150b">
					<c:forEach items="${page.list}" var="page">
						<li>
							<a href="javascript:void(0)" onclick="window.open('/html/product/${page.id}.html')" title="${page.name}" class="pic"><img src="${page.img.allUrl }" alt="${page.name}" /></a>
							<dl>
								<!-- dt 10个文字+... -->
								<dt><a href="javascript:void(0)" onclick="window.open('/product/display/detail.shtml?id=${page.id}')" title="${page.name}" >${page.name}</a></dt>
								<!-- dt 25个文字+... -->
								<dd class="h40">${page.name}</dd>
