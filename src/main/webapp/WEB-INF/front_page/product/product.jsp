			...
			<div class="mt ofc">
				<ul class="uls i_150x150 x4_150x150b">
					<c:forEach items="${page.list}" var="page">
						<li>
							<a href="productDetail.jsp" title="${page.name}" target="_blank" class="pic"><img src="${page.img.allUrl }" alt="${page.name}" /></a>
							<dl>
								<!-- dt 10个文字+... -->
								<dt><a href="productDetail.jsp" title="${page.name}" target="_blank">${page.name}</a></dt>
								<!-- dt 25个文字+... -->
