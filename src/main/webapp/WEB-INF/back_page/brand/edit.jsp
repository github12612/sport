			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						...
						<input type="file" onchange="imgUpload()" name="pic"/>
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="radio" name="isDisplay" value="1" <c:if test="${brand.isDisplay==1}">checked="checked"</c:if>>可用</input>
						<input type="radio" name="isDisplay" value="0" <c:if test="${brand.isDisplay==0}">checked="checked"</c:if>>不可用</input>
					</td>
				</tr>
			</tbody>
			<tbody>
